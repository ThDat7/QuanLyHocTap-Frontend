          ...
          <Row>
            <Col md={8}>
              <Routes>
                ...
                />
                <Route
                  path={`${Urls['adminEducationProgram']}`}
                  element={<EducationProgram />}
                />
                <Route
                  path={`${Urls['adminEducationProgram']}:id`}
                  element={<EducationProgramEdit />}
                />
                <Route
                  path={`${Urls['adminEducationProgram']}create`}
                  element={<EducationProgramEdit />}
                />
